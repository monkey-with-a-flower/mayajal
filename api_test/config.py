...
ROOT_ADMIN_USERNAME = os.getenv("ROOT_ADMIN_USERNAME", "root")
ROOT_ADMIN_PASSWORD = os.getenv("ROOT_ADMIN_PASSWORD", "MayajalRoot!2026")
ROOT_ADMIN_EMAIL = os.getenv("ROOT_ADMIN_EMAIL", "root@mayajal.local")
SEED_DEMO_DATA = os.getenv("MAYAJAL_SEED_DEMO", "false").lower() in {"1", "true", "yes"}
